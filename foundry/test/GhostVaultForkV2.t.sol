...
contract GhostVaultForkV2Test is Test {
    ...
    function setUp() public {
        ...
        deployCodeTo(
            'GhostVaultHookV2.sol:GhostVaultHookV2', abi.encode(POOLMANAGER_BASE_MAINNET, ETH_USD_FEED_BASE_MAINNET, address(this)), hookAddr
        );
    ...
    function test_ForkBatchExecution() public {
        ...
        console2.log("Order 0: %s USDC, Order 1: %s USDC", deposit0 / 1e6, deposit1 / 1e6);
        ...
        console2.log("Batch executed: WETH=%s, solverFee=%s", wethReceived, solverFee);
